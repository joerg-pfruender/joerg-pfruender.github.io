...
```
This looks ugly. I would use this only a means of last resort.
...
### Where should I put my logs? stdout, stderr, files?
...
### Should I use slf4j's parameterized logging?
