...
![Port](/assets/database-schema.jpg)
...
I don't want to go back to the times when all we had was the simple JDBC API and we all used to write handcrafted value mappings from query results to java object.
...
I want to see which SQL statement is responsible from the source of the stack trace, but that's impossible.
